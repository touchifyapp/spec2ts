...
export function isReference(obj: Record<string, any> | null | undefined): obj is JSONReference {
...
export async function createContext(schema: Record<string, any>, options: ParserOptions): Promise<ParserContext> {
